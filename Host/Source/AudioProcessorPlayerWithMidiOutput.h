...
#ifndef JUCE_AudioProcessorPlayerWithMidiOutput_H_INCLUDED
#define JUCE_AudioProcessorPlayerWithMidiOutput_H_INCLUDED
...
*/
class JUCE_API  AudioProcessorPlayerWithMidiOutput    : public AudioIODeviceCallback,
                                          public MidiInputCallback
{
public:
    //==============================================================================
    AudioProcessorPlayerWithMidiOutput();

    /** Destructor. */
    virtual ~AudioProcessorPlayerWithMidiOutput();
    ...
    */
    ...
    void setDeviceManager(AudioDeviceManager* deviceManager) { this->deviceManager = deviceManager; }
...
private:
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (AudioProcessorPlayerWithMidiOutput)
};


#endif   // JUCE_AudioProcessorPlayerWithMidiOutput_H_INCLUDED
